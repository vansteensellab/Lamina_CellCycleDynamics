...
# 
# Prepare output
output_dir <- "ts191212_figure_track_Hap1_CellCycle"
dir.create(output_dir, showWarnings = FALSE)

# Load the data sets required
file_names <- c("g1", "s", "g2", "padamid", "damid")

padamid <- import("../ts180813_GCF5083_pADamIDtests/results/tracks/normalized/bin-20kb/Hap1_LMNB2-20kb-combined.bw")
damid <- import("~/mydata/proj/3D_nucleus/results/ts180110_4DN_DataProcessing/results/tracks/normalized/bin-20kb/Hap1_LMNB1-20kb-combined.bw")
g1 <- import("results/tracks/normalized/bin-20kb/pADamID-Hap1_G1_LMNB2-20kb-combined.bw")
s <- import("results/tracks/normalized/bin-20kb/pADamID-Hap1_S_LMNB2-20kb-combined.bw")
g2 <- import("results/tracks/normalized/bin-20kb/pADamID-Hap1_G2_LMNB2-20kb-combined.bw")
...
bins <- read.table("../ts180813_GCF5083_pADamIDtests/results/counts/bin-20kb/pADamID-Hap1_r4_Dam_semibad-Dam-20kb.counts.txt.gz",
                   sep = "\t")[, 1:3]
