...
# 
# Prepare output
output_dir <- "ts191212_figure_track_HCT116_CellCycle"
dir.create(output_dir, showWarnings = FALSE)

# Load the data sets required
file_names <- c("g1", "s", "g2", "padamid", "damid")

padamid <- import("../ts180813_GCF5083_pADamIDtests/results/tracks/normalized/bin-20kb/HCT116_LMNB2-20kb-combined.bw")
damid <- import("~/mydata/proj/3D_nucleus/results/ts180110_4DN_DataProcessing/results/tracks/normalized/bin-20kb/HCT116_LMNB1-20kb-combined.bw")
