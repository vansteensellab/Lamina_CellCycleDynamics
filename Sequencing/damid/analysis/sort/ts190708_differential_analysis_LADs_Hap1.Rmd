---
title: "Cell cycle sorting - differential LADs - Hap1"
...
plot(1, 1, type = "n", xlim = c(-5, 5), ylim = c(0, 0.3),
...
plot(1, 1, type = "n", xlim = c(-3, 3), ylim = c(0, 0.5),
     xlab = "Dam-ratio (log2)", ylab = "density", main = "Density Dam ratio for bins")
...
# Get the results
results <- decideTests(fit, adjust.method = "BH", p.value = 0.01, method = "global")
